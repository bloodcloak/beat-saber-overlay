...
3. Set the URL as `http://bloodcloak.github.io/overlay/` (HTTP, not HTTPS!) and the size equal to your canvas size (1280x720, etc.)

![image](https://imgur.com/KxowYrw.png)

4. (Optional) For 1080p canvases, add the `scale` modifier (ex. `http://bloodcloak.github.io/overlay/?modifiers=scale`) to scale the overlay by 1.5x
...
```
http://bloodcloak.github.io/overlay/?modifiers=top
```
